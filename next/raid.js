  ...
  for (var i = 0; i < e.detail.logs.length; i++) {
    ...
    if (actionLine.trickattack) {
      if (actionLine.trickattack[4].length == 8) {
        ...
        // document.getElementById("debug1").innerText = "Trick Attack Successful on " + actionLine.trickattack[3] + " by " + actionLine.trickattack[1];
      }
      /* else {
        document.getElementById("debug1").innerText = "Trick Attack Unsuccessful";
      } */
    }
