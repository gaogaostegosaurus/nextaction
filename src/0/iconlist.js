...
icon.bloodletter = '000361';
icon.venomousbite = '000363';
icon.windbite = '000367';
icon.battlevoice = '002601';
icon.magesballad = '002602';
icon.armyspaeon = '002603';
icon.requiem = '002604';
icon.rainofdeath = '002605';
icon.empyrealarrow = '002606';
icon.thewanderersminuet = '002607';
